...
void mimc_sig_verifier_28_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void mimc_sig_verifier_28_run(uint ctx_index,Circom_CalcWit* ctx);
...
mimc_sig_verifier_28_run };
uint get_main_input_signal_start() {return 1;}

uint get_main_input_signal_no() {return 7;}

uint get_total_signal_no() {return 21743;}
...
ctx->componentMemory[coffset].templateName = "mimc_sig_verifier";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 7;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
mimc_sig_verifier_28_create(1,0,ctx,"main",0);
mimc_sig_verifier_28_run(0,ctx);
}
